...
function somar($valor1, $valor2){
    ...
    Este tipo de variável existe somente dentro da função que foi declarada. */
    $total = $valor1 + $valor2;
...
<?php
// Útil para funções simples de uma única linha e com return implicíto
// Obs.: esta sintaxe só permite UMA ÚNICA operação (sem {}, sem return explicíto)
$dobrarValor = fn(int $valor) => $valor * 2;
?>
            <p><?=$dobrarValor(10)?></p>
            <p><?=$dobrarValor(100)?></p>
